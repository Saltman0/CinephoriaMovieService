...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "halls" ADD CONSTRAINT "halls_showId_showtimes_id_fk" FOREIGN KEY ("showId") REFERENCES "public"."showtimes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "halls" ADD CONSTRAINT "halls_cinemaId_cinemas_id_fk" FOREIGN KEY ("cinemaId") REFERENCES "public"."cinemas"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
